...
SOURCEFILES_QUOTED_IF_SPACED=lab6.s OledGrph.c OledDriver.c FillPat.c ChrFont0.c main.c OledChar.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/lab6.o ${OBJECTDIR}/OledGrph.o ${OBJECTDIR}/OledDriver.o ${OBJECTDIR}/FillPat.o ${OBJECTDIR}/ChrFont0.o ${OBJECTDIR}/main.o ${OBJECTDIR}/OledChar.o
POSSIBLE_DEPFILES=${OBJECTDIR}/lab6.o.d ${OBJECTDIR}/OledGrph.o.d ${OBJECTDIR}/OledDriver.o.d ${OBJECTDIR}/FillPat.o.d ${OBJECTDIR}/ChrFont0.o.d ${OBJECTDIR}/main.o.d ${OBJECTDIR}/OledChar.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/lab6.o ${OBJECTDIR}/OledGrph.o ${OBJECTDIR}/OledDriver.o ${OBJECTDIR}/FillPat.o ${OBJECTDIR}/ChrFont0.o ${OBJECTDIR}/main.o ${OBJECTDIR}/OledChar.o

# Source Files
SOURCEFILES=lab6.s OledGrph.c OledDriver.c FillPat.c ChrFont0.c main.c OledChar.c
...
${OBJECTDIR}/lab6.o: lab6.s  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/lab6.o 
	@${FIXDEPS} "${OBJECTDIR}/lab6.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC} $(MP_EXTRA_AS_PRE)  -D__DEBUG  -D__MPLAB_DEBUGGER_PK3=1 -c -mprocessor=$(MP_PROCESSOR_OPTION)  -o ${OBJECTDIR}/lab6.o lab6.s  -Wa,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_AS_POST),--defsym=__ICD2RAM=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,--gdwarf-2,-MD="${OBJECTDIR}/lab6.o.d"
else
${OBJECTDIR}/lab6.o: lab6.s  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/lab6.o 
	@${FIXDEPS} "${OBJECTDIR}/lab6.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC} $(MP_EXTRA_AS_PRE)  -c -mprocessor=$(MP_PROCESSOR_OPTION)  -o ${OBJECTDIR}/lab6.o lab6.s  -Wa,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_AS_POST),--gdwarf-2,-MD="${OBJECTDIR}/lab6.o.d"
endif
...
dist/${CND_CONF}/${IMAGE_TYPE}/lab6.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mdebugger -D__MPLAB_DEBUGGER_PK3=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/lab6.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}           -mreserve=data@0x0:0x1FC -mreserve=boot@0x1FC02000:0x1FC02FEF -mreserve=boot@0x1FC02000:0x1FC024FF  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/lab6.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/lab6.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"
